    ...
    <div class="dnt-contact-info-grid">
        <div class="dnt-contact-card">
            ...
            <div class="dnt-contact-card-details">
                ...
                <p>প্রধান ক্যাম্পাস, বঙ্গবীর রোড,<br>দক্ষিণ সুরমা, সিলেট, বাংলাদেশ।</p>
            </div>
        </div>
        ...
        <div class="dnt-contact-card">
            ...
            <div class="dnt-contact-card-details">
                <h4>ফোন ও মোবাইল</h4>
                <p>হটলাইন: <a href="tel:01755592295" style="color: inherit; text-decoration: none;">০১৭৫৫-৫৯২২৯৫</a></p>
            </div>
        </div>
        ...
        <form action="#" method="POST">
            <div class="dnt-form-grid">
                <div class="dnt-form-group">
                    ...
                    <input type="text" id="contact-name" class="dnt-form-control" placeholder="উদাঃ আব্দুল্লাহ নাহিয়ান" required>
                </div>
                <div class="dnt-form-group">
                    <label for="contact-phone">সক্রিয় মোবাইল নম্বর <span>*</span></label>
                    <input type="tel" id="contact-phone" class="dnt-form-control" placeholder="উদাঃ ০১৭৫৫-৫৯২২৯৫" required>
                </div>
