...
/*
Template Name: Teachers College
*/
...
// Fetch Active College Teachers from EduCore Plugin DB
$college_teachers = $wpdb->get_results( 
    $wpdb->prepare(
...
<style>
    ...
    <section class="dnt-page-banner" style="background-image: url('<?php echo esc_url( get_template_directory_uri() . '/assets/img/breadcrumb.jpg' ); ?>');">
        <div class="dnt-container">
            <h1 class="dnt-page-title">শিক্ষকমণ্ডলী (কলেজ শাখা)</h1>
            <div class="dnt-breadcrumb">
                ...
                <span style="color:var(--dnt-color-gray-300);">শিক্ষকমণ্ডলী (কলেজ শাখা)</span>
            </div>
        </div>
    </section>
        ...
        <div class="dnt-container">
            ...
            <main class="dnt-page-content" style="width: 100%;">
                ...
                <h2 class="dnt-section-heading" style="display:flex; align-items:center; gap:10px;">
                    ...
                    শিক্ষকমণ্ডলী (একাদশ - দ্বাদশ শ্রেণি)
                </h2>
                
                <p class="dnt-intro-text">
                    কলেজ শাখায় পাঠদানের জন্য রয়েছেন একঝাঁক অভিজ্ঞ, উচ্চশিক্ষিত এবং নিবেদিতপ্রাণ শিক্ষকমণ্ডলী। ডিজিটাল কন্টেন্ট এবং আধুনিক পাঠদান পদ্ধতির মাধ্যমে তারা শিক্ষার্থীদের মাঝে জ্ঞানের আলো ছড়িয়ে দিচ্ছেন।
                </p>

                <!-- Dynamic Teacher Grid -->
                <div class="dnt-teacher-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px;">
                    <?php if ( ! empty( $college_teachers ) ) : foreach ( $college_teachers as $teacher ) : ?>
                        <div class="dnt-teacher-card">
                            ...
                            <div class="dnt-teacher-edu">
                                <?php echo esc_html( ! empty( $teacher->highest_degree ) ? $teacher->highest_degree : 'প্রভাষক / শিক্ষক (কলেজ শাখা)' ); ?>
                            </div>
                    ...
                    <?php endforeach; else : ?>
                        <div style="grid-column: 1 / -1; text-align: center; padding: 40px; background: #f8fafc; border-radius: 8px;">
                            <p style="margin: 0; color: #64748b; font-size: 1rem;">কলেজ শাখার কোনো শিক্ষকের তথ্য পাওয়া যায়নি।</p>
                        </div>
                    <?php endif; ?>
                </div>
