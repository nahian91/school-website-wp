...
get_header(); ?>
    ...
    <section class="dnt-page-banner" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/breadcrumb.jpg');">
        <div class="dnt-container">
            <h1 class="dnt-page-title">পরীক্ষার সময়সূচী</h1>
            <div class="dnt-breadcrumb">
                ...
                <span style="color:var(--dnt-color-gray-300);">পরীক্ষার সময়সূচী</span>
            </div>
        </div>
    </section>
        ...
        <div class="dnt-container dnt-page-grid">
            ...
            <main class="dnt-page-content">
                ...
                <p class="dnt-intro-text">
                    Green Gems International School & College-এর ২০২৬ শিক্ষাবর্ষের অর্ধ-বার্ষিক পরীক্ষার বিস্তারিত সময়সূচী নিচে দেওয়া হলো। সকল শিক্ষার্থীদের পরীক্ষার ৩০ মিনিট পূর্বে নির্ধারিত কক্ষে উপস্থিত থাকার জন্য নির্দেশ দেওয়া যাচ্ছে।
                </p>
