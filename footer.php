                ...
                <div class="dnt-footer-widget">
                    ...
                    <ul class="dnt-contact-list">
                        <li>
                            ...
                            <span>রংমহল টাওয়ার, বন্দরবাজার,<br>সিলেট-৩১০০, বাংলাদেশ।</span>
                        </li>
                        <li>
                            <!-- Phone Icon -->
                            <svg class="dnt-icon-sm dnt-contact-icon" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <span>০১৩০০-০০০০০০ (হটলাইন)<br>০২১-৭২২২২২ (টেলিফোন)</span>
                        </li>
                        <li>
                            <!-- Email Icon -->
                            <svg class="dnt-icon-sm dnt-contact-icon" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <span>info@ggisc.edu.bd<br>principal@ggisc.edu.bd</span>
                        </li>
                    </ul>
                </div>
