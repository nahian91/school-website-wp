        ...
        <div class="dnt-container dnt-page-grid">
            ...
            <main class="dnt-page-content">
                ...
                <p class="dnt-intro-text">
                    আদর্শ উচ্চ বিদ্যালয় ও কলেজ-এ আমরা বিশ্বাস করি, প্রকৃত শিক্ষা শুধু শ্রেণিকক্ষের চার দেয়ালের মাঝে সীমাবদ্ধ নয়। শিক্ষার্থীদের আত্মবিশ্বাস, নেতৃত্ব এবং সৃজনশীলতা বৃদ্ধির লক্ষ্যে আমরা বিভিন্ন ধরণের সহ-শিক্ষা কার্যক্রম পরিচালনা করি। নিচে আমাদের ক্লাবসমূহের বিস্তারিত কার্যক্রম তুলে ধরা হলো।
                </p>
